...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _themeBackgroundView = [[XXImageView alloc]initWithFrame:CGRectMake(0,0,frame.size.width,frame.size.height * 1/2)];
        ...
        _nameLabel.frame = CGRectMake(70,30,180,35);
        ...
        _sexImageView.frame = CGRectMake(140,_nameLabel.frame.origin.y+_nameLabel.frame.size.height+3,10,10);
        [_infoBackgroundView addSubview:_sexImageView];
        
        //star label
        _starLabel = [[UILabel alloc]init];
        _starLabel.frame = CGRectMake(_sexImageView.frame.origin.x+_sexImageView.frame.size.width+7,_sexImageView.frame.origin.y-5,45,20);
        ...
        _teaseButton.frame = CGRectMake(100,_starLabel.frame.origin.y+_starLabel.frame.size.height+10,130, 35);
        [_teaseButton teaseStyle];
        [_teaseButton setNormalIconImage:@"other_tease.png" withSelectedImage:@"other_tease.png" withFrame:CGRectMake(30,8,27,18)];
