...
@interface ShareUserFilterViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation ShareUserFilterViewController
...
- (void)loadViewAbout
{
    ...
    UITableView * tableView  =[[UITableView alloc]initWithFrame:CGRectMake(0, 110+originY, 320, 46.5*3+46+45.5) style:UITableViewStylePlain];
