...
- (void)loadViewAbout
{
    ...
    XXSegmentControl *segBoyGire =[[XXSegmentControl alloc]initWithFrame:CGRectMake(10, 16, 300, 47) withConfigArray:@[leftIten,midIten,rightiten]];
    ...
    XXSegmentControl *AboutKnow =[[XXSegmentControl alloc]initWithFrame:CGRectMake(10, 63+16, 300, 47) withConfigArray:@[leftAboutKnowItem,rightAboutKnowiten]];
    AboutKnow.backgroundColor = [UIColor clearColor];
    [self.view addSubview:AboutKnow];
    
    
    CGFloat originY = IS_IOS_7? 0:10;
    
    UITableView * tableView  =[[UITableView alloc]initWithFrame:CGRectMake(0, 110+32+originY, 320, 46.5*3+46+45.5) style:UITableViewStylePlain];
